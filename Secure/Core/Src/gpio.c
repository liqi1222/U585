...
void MX_GPIO_Init(void)
{
  ...
  /*
   * LD6/LD7 are article-demo resources. Keep the boot and UART bridge in the
   * Secure image, but release PH6/PH7 so the NonSecure application can own and
   * drive the LEDs directly through GPIOH_NS.
   */
